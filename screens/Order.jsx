...
import { View, Text, ScrollView, RefreshControl, Alert, SafeAreaView, TouchableOpacity } from 'react-native';
              ...
              <DataTable>
                ...
                {order.slice(startIndex, endIndex).map((item, index) => (
                  <DataTable.Row key={index}>
                    ...
                    <DataTable.Cell>
                      <TouchableOpacity className="p-2 px-4 bg-blue-500 rounded-xl">
