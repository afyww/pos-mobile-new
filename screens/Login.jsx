...
import { View, TextInput, TouchableOpacity, Text, Alert, KeyboardAvoidingView, ScrollView, RefreshControl, Platform } from 'react-native';
...
function Login() {
    ...
    return (
        <KeyboardAvoidingView
            ...
            style={{ flex: 1 }}>
            <View className="h-screen bg-red-900">
                    <View className="">
                        <View className="p-10">
                            <View>
